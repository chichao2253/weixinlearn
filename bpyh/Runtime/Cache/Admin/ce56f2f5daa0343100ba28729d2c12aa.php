...
<table width="1224" border="0" cellpadding="0" cellspacing="0" class="main">
  ...
  <tr valign="top">
    <td align="center" class="maincontent"><form name="form1" method="post" action="">
              ...
              <table width="100%" id="form_ck" border="0" cellpadding="2" cellspacing="1" class="midTable1">
                ...
                <tr class="midTable1td4">
                  <td colspan="6" align="right">
				  	<input name="Submit3" type="button" onclick="tingyong(-1)" class="button" value="停用">
...
<!-- #EndLibraryItem -->
 ...
 <script>
	...
	$(function(){		
    			$.get("http://localhost/index.php/Admin/object/stopshuju",{
    				version:0.1,
...
<script>
	...
	function ajaxshenpi(obj,ojb){
		$.get('http://localhost/index.php/Admin/object/ajaxtingyong',{
			id:obj,staus:ojb
		},function(data,textStatus){
    		if(data.err==1){
    			alert('停用成功');
