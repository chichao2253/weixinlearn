...
! function(e) {
	...
	o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function(e, t) {
		...
		function s(e, t) {
			...
			("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[y] = t, m.removeChild(p), function i() {
				return ++v > 1e3 * o.timeout / 4 ? r(y + " is not a valid module") : void(o.status[y] ? c() : setTimeout(i, 4))
			}())
		}

		function c() {
			a.push(layui[y]), e.length > 1 ? d.use(e.slice(1), t, a) : "function" == typeof t && t.apply(layui, a)
		}
		var d = this,
			f = o.dir = o.dir ? o.dir : i,
			m = n.getElementsByTagName("head")[0];
		e = "string" == typeof e ? [e] : e, window.jQuery && jQuery.fn.on && (d.each(e, function(t, n) {
			"jquery" === n && e.splice(t, 1)
		}), layui.jquery = jQuery);
		var y = e[0],
			v = 0;
		if(a = a || [], o.host = o.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length) return t();
		var p = n.createElement("script"),
			h = (l[y] ? f + "lay/" : o.base || "") + (d.modules[y] || y) + ".js";
		return p.async = !0, p.charset = "utf-8", p.src = h + function() {
			var e = o.version === !0 ? o.v || (new Date).getTime() : o.version || "";
			return e ? "?v=" + e : ""
		}(), o.modules[y] ? ! function g() {
			return ++v > 1e3 * o.timeout / 4 ? r(y + " is not a valid module") : void("string" == typeof o.modules[y] && o.status[y] ? c() : setTimeout(g, 4))
		}() : (m.appendChild(p), !p.attachEvent || p.attachEvent.toString && p.attachEvent.toString().indexOf("[native code") < 0 || u ? p.addEventListener("load", function(e) {
			s(e, h)
		}, !1) : p.attachEvent("onreadystatechange", function(e) {
			s(e, h)
		})), o.modules[y] = h, d
	}, t.fn.all = function(e) {
		return this.use("layui.mod", e), this
		...
		var s = (i || e).replace(/\.|\//g, ""),
			c = l.id = "layuicss-" + s,
			d = 0;
		l.rel = "stylesheet", l.href = e + (o.debug ? "?v=" + (new Date).getTime() : ""), l.media = "all", n.getElementById(c) || a.appendChild(l), "function" == typeof t && ! function f() {
			return ++d > 1e3 * o.timeout / 100 ? r(e + " timeout") : void(1989 === parseInt(u.getStyle(n.getElementById(c), "width")) ? function() {
				t()
			}() : setTimeout(f, 100))
		}()
